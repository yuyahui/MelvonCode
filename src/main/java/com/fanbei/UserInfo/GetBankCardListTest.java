...
//银行卡列表
public class GetBankCardListTest {
	
	String baseUrl = PropertiesHandle.readValue("baseUrl");
	String testUrl = "user/getBankCardList";	
	...
	public void getBankCardList(String userName, String exCode, String exMess) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, ClientProtocolException, IOException, NoSuchAlgorithmException{
